...
<CollapserGroup>
  ...
  >
    ...
    * Browser events: Disabled
      ...
      <DNT>**Note:**</DNT> The `httpResponseCode` attribute (string value) is removed as of agent version 7.0.0. `http.statusCode` (string type containing just the numerical status code) should be used instead.
  </Collapser>
  ...
  >
    ...
    * Browser events: Disabled
      ...
      <DNT>**Note:**</DNT> The `httpResponseMessage` attribute (string value) is removed as of agent version 7.0.0. `http.statusText` (string value) should be used instead.
  </Collapser>
